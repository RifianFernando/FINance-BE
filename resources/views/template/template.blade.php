...
<div class="flex flex-row">
    <!-- Side Menu Desktop  -->
    <div
        class="sticky max-w-[300px] hidden flex-col px-10 pt-16 h-screen bg-[#23273C] text-[#FAFAFA] md:flex justify-between left-0 top-0 font-poppins">
        <div class="flex flex-col">
            <h3 class="text-2xl lg:text-4xl font-bold text-left">FINEance</h3>
            <ul class="mt-8 text-sm">
                <li class="pt-5 hover:scale-110 hover:pl-1"><a href="/dashboard"
                        class="text-white no-underline">Dashboard</a></li>
                <li class="pt-5 hover:scale-110 hover:pl-1"><a href="/transaction"
                        class="text-white no-underline">Transaction</a></li>
                <li class="pt-5 hover:scale-110 hover:pl-1"><a href="/report" class="text-white no-underline">Report</a>
                </li>
                <li class="pt-5 hover:scale-110 hover:pl-1"><a href="/subscription"
                        class="text-white no-underline">Subscription</a></li>
                <li class="pt-5 hover:scale-110 hover:pl-1"><a href="/customer-center"
                        class="text-white no-underline">Customer Center</a></li>
            </ul>
        </div>
    ...
    <div class="flex flex-col right-0 top-0 fixed py-4 px-8 font-poppins">
        <div onClick="ChangeNavStyle()" class="md:hidden">
            <button><img class="w-[30px] h-[30px]" src="{{ asset('assets/navbar/Hamburger.png') }}"
                    id="MobileIcon"></button>
        </div>
    ...
    <div id="OptionMenu" class="hidden font-poppins" onClick="OptionNav()">
        ...
        <ul class="mt-10 text-sm">
            <li class="pt-5 hover:scale-110 hover:pl-1"><a href="#" class="text-white no-underline">Profile</a>
            </li>
            <form method="POST" action="{{ route('logout') }}" class="pt-5 hover:scale-110 hover:pl-1">
                @csrf
...
<div
    class='grid w-full mx-auto py-16 px-10 gap-8 gap-y-10 md:grid-cols-5 bg-[#383A40] text-[#EDEDF3] lg:gap-y-0 font-poppins'>
    ...
    <div
        class='lg:flex grid grid-cols-2 lg:grid-cols-4 col-span-0 md:col-span-4 justify-between md:gap-x-4 mt-6 col-span-2'>
        <div class=''>
            <h4 class='font-bold text-left text-lg'>Navigate</h4>
            <ul class="">
                <li class="text-left test-xs hover:scale-110"><a href="/dashboard"
                        class="text-white no-underline">Dashboard</a></li>
                <li class="text-left test-xs hover:scale-110"><a href="/transaction"
                        class="text-white no-underline">Transaction</a></li>
                <li class="text-left test-xs hover:scale-110"><a href="/report"
                        class="text-white no-underline">Report</a></li>
                <li class="text-left test-xs hover:scale-110"><a href="/subscription"
                        class="text-white no-underline">Subscription</a></li>
                <li class="text-left test-xs hover:scale-110"><a href="/customer-center"
                        class="text-white no-underline">Customer Center</a></li>
            </ul>
        </div>
        ...
        <div class=''>
            ...
            <ul>
                <li class='text-left test-xs hover:scale-110'><a href="/team" class="text-white no-underline">Meet
                        The Team</a></li>
                <li class='text-left test-xs hover:scale-110'><a href="/faq"
                        class="text-white no-underline">FAQ</a></li>
                <li class='text-left test-xs hover:scale-110'><a href="/blog"
                        class="text-white no-underline">blog</a></li>
            </ul>
        </div>
        ...
        <div class=" flex flex-col gap-y-2 mt-4 lg:mt-0">
            ...
            <div className=" bg-gray-500 col-span-2">
                <input type="email" name="" id="" placeholder="Fill Your Email!"
                    class="text-xs md:text-lg w-4/5 text-left outline-none focus:bg-slate-200 bg-white rounded-md flex py-2 text-gray-500" />
                <button
                    class=" bg-gray-800 text-sm text-white hover:scale-110 ease-linear duration-250 rounded-md py-2 sm:text-md md:text-xl md:p-3 my-3 px-6 md:py-2 md:px-0 md:w-[120px] duration-300">
                    Submit
                    <button>
            </div>

            <div class=" w-full col-span-5 md:col-span-2 text-xs md:text-md">
                <p class="text-left">Your Information will be protected, see our <span class="underline">Privacy
                        Policy</span></p>
            </div>
