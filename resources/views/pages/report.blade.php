        ...
        <div class="flex flex-col items-center w-full bg-darker-white">
            ...
            <!-- First Row -->
                ...
                <div class=" flex grid- gap-x-2 justify-center col-span-1">
                     ...
                     <div class="w-[550px] h-[360px] border-gray-500 border-1 border-solid bg-white drop-shadow-subs-card rounded-md">
                    ...
                    <div class="max-w-[550px] h-[360px] border-gray-500 border-1 border-solid  bg-white drop-shadow-subs-card rounded-md">
                        <div class="flex justify-center flex-col w-full">
                            <div class="flex justify-center">
