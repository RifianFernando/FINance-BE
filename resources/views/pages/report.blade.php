...
@section('body')
    ...
    <body>
        <div class="flex flex-col items-center w-full bg-darker-white">
            <div class="flex flex-col items-center max-w-[1520px] ">
                <div>
                ...
                <div class="grid grid-cols-2 mt-4 p-4 gap-y-5 w-full gap-x-5">
                    ...
                    <div class="grid grid-cols-12 w-full gap-x-2 xl:gap-x-6 gap-y-4 sm:gap-y-2 col-span-2">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <h1 class="flex flex-row items-center text-2xl"><img
                    ...
                    <div class=" grid grid-cols-4 gap-x-5 justify-center col-span-2 ">
                        ...
                        <div
                            class=" border-gray-500 border-1 border-solid bg-white drop-shadow-subs-card rounded-md col-span-1">
